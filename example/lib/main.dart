...
class _MyHomePageState extends State<MyHomePage> {
  ...
  SlideIndicator _slideIndicator =
      CircularSlideIndicator(padding: EdgeInsets.only(bottom: 32));
                        ...
                        return Column(
                          ...
                          children: <Widget>[
                            ...
                            _getTransformRadio(Transforms.FlipVerticalTransform,
                                _transform, setState),
                            _getTransformRadio(Transforms.DrawFromBackTransform,
                                _transform, setState),
  ...
  SlideTransform _getTransform(Transforms transform) {
    switch (transform) {
      ...
      case Transforms.DrawFromBackTransform:
        return DrawFromBackTransform();
